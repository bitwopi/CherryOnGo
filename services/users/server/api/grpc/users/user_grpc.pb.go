...
const (
	UserService_SignUpUser_FullMethodName  = "/users.UserService/SignUpUser"
...
func (c *userServiceClient) AuthUser(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*JWTResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JWTResponse)
...
func (c *userServiceClient) RefreshJWT(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*JWTResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JWTResponse)
...
func (c *userServiceClient) GetUserData(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) RefreshJWT(context.Context, *RefreshRequest) (*JWTResponse, error) {
...
func _UserService_SignUpUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SignUpUser(ctx, req.(*AuthRequest))
	}
...
func _UserService_RefreshJWT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).RefreshJWT(ctx, req.(*RefreshRequest))
	}
	return interceptor(ctx, in, info, handler)
}
